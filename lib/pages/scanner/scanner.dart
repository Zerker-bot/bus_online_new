...
class BarcodeScannerWithControllerState
  ...
  Widget build(BuildContext context) {
    final ValueNotifier<TorchState> torchState = ValueNotifier<TorchState>(controller.value.torchState);
    final ValueNotifier<CameraFacing> cameraFacing = ValueNotifier<CameraFacing>(controller.value.cameraDirection);
